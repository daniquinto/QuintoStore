...
const Home = () => {
  ...
  const categories = [
    { name: "Electronics", slug: "electronics", image: "https://images.unsplash.com/photo-1498049794561-7780e7231661?q=80&w=1000&auto=format&fit=crop" },
    { name: "Jewelry", slug: "jewelery", image: "https://images.unsplash.com/photo-1601121141461-9d6647bca1ed?q=80&w=1000&auto=format&fit=crop" },
    { name: "Men's Fashion", slug: "men's clothing", image: "https://images.unsplash.com/photo-1490114538077-0a7f8cb49891?q=80&w=1000&auto=format&fit=crop" },
    { name: "Women's Fashion", slug: "women's clothing", image: "https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?q=80&w=1000&auto=format&fit=crop" },
  ];
  ...
  return (
    <div className="bg-white overflow-hidden">
      {/* Hero Section */}
      <section className="relative min-h-[80vh] md:h-[90vh] flex items-center overflow-hidden bg-quinto-950">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full py-20 md:py-0">
          <div className="max-w-3xl">
            <span className="text-quinto-400 font-black uppercase tracking-[0.4em] mb-4 md:mb-6 block text-[10px] md:text-xs">Limited Edition 2026</span>
            <h1 className="text-5xl sm:text-6xl md:text-8xl font-black text-white tracking-tighter leading-[0.9] mb-8">
              UNCOMPROMISED <span className="text-quinto-500">QUALITY</span> FOR YOU.
            </h1>
            <p className="text-quinto-200 text-base md:text-lg font-medium mb-10 max-w-lg leading-relaxed opacity-80">
              Quinto Store brings you a selection of premium essentials crafted with precision and designed for excellence.
            </p>
            <div className="flex flex-wrap gap-6">
              <Link to="/gallery" className="quinto-btn-primary group w-full sm:w-auto text-center justify-center">
                Explore Collection
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl font-black text-quinto-950 tracking-tighter uppercase">Browse Categories</h2>
          <p className="text-[10px] md:text-xs font-bold text-quinto-600 uppercase tracking-widest mt-2">Curated for your lifestyle</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 h-auto md:h-[600px]">
          {categories.map((cat, i) => (
            <div 
              ...
              className={`group relative overflow-hidden rounded-[2rem] cursor-pointer h-[300px] md:h-auto ${i === 0 || i === 3 ? 'md:col-span-2' : ''} transition-all duration-700 hover:shadow-2xl hover:shadow-quinto-900/20`}
            >
      ...
      <section className="bg-quinto-50/50 py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-6">
            <div>
              <h2 className="text-3xl md:text-4xl font-black text-quinto-950 tracking-tighter uppercase">Best Sellers</h2>
              <p className="text-[10px] md:text-xs font-bold text-quinto-600 uppercase tracking-widest mt-2">The most loved pieces in our store</p>
            </div>
            <Link to="/gallery" onClick={() => setSelectedCategory('')} className="text-[10px] font-black uppercase tracking-[0.2em] text-quinto-900 border-b-2 border-quinto-500 hover:text-quinto-500 transition-all">
              View All Collection
            </Link>
          </div>
      ...
      {/* Footer Minimalist */}
      <footer className="bg-quinto-950 py-16 md:py-20 text-white">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 text-center md:text-left">
          ...
          <div>
            <h4 className="text-[11px] font-black uppercase tracking-[0.3em] text-quinto-500 mb-6 md:mb-8">Menu</h4>
          ...
          <div>
            <h4 className="text-[11px] font-black uppercase tracking-[0.3em] text-quinto-500 mb-6 md:mb-8">Support</h4>
            <ul className="space-y-4 text-xs font-bold uppercase tracking-widest opacity-60">
        ...
        <div className="max-w-7xl mx-auto px-6 mt-16 md:mt-20 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-[9px] font-bold uppercase tracking-[0.3em] opacity-40">
